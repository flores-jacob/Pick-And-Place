...
print("unadjusted theta_3 ",
      theta_3[0].evalf(subs={q1: q1_val, q2: q2_val, q3: q3_val, q4: q4_val, q5: q5_val, q6: q6_val}))
...
R0_3 = T0_3[0:3, 0:3] * R_corr_3_and_5[0:3, 0:3]
...
R0_6 = T0_6[0:3, 0:3] * R_corr_4_6_and_gripper[0:3, 0:3]
